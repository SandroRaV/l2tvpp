...
| `node.c` | `l2tvpp-input`: udp 1701 decap + punt | `plugins/pppoe/pppoe_decap.c` |
| `handoff.c` | `l2tvpp-handoff`: spread decap across workers by session (M3) | `plugins/nat/nat44-ed/nat44_ed_handoff.c` |
